...
let speed = 1;
const bunnyAccelerator = new Accelerator([0, 0.01]);
const bg_layer1 = await Assets.load("assets/bg_layer1.png");
const bunny_stand = await Assets.load("assets/bunny1_stand.png");
const bunny_jump = await Assets.load("assets/bunny1_jump.png");
const carrotTexture = await Assets.load("assets/carrot.png");
const ground_grass = await Assets.load("assets/ground_grass.png");
